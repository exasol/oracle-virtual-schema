...
| [jersey-core-client][34]                        | [EPL 2.0][35]; [GPL2 w/ CPE][36]; [EDL 1.0][37]; [BSD 2-Clause][38]; [Apache License, 2.0][39]; [Public Domain][40]; [Modified BSD][41]; [jQuery license][42]; [MIT license][43]; [W3C license][44] |
| [JaCoCo :: Agent][45]                           | [EPL-2.0][46]                                                                                                                                                                                       |

### Runtime Dependencies

| Dependency                    | License                                                                                                        |
| ----------------------------- | -------------------------------------------------------------------------------------------------------------- |
| [JSON-P Default Provider][47] | [Eclipse Public License 2.0][48]; [GNU General Public License, version 2 with the GNU Classpath Exception][49] |

### Plugin Dependencies

| Dependency                                              | License                                     |
| ------------------------------------------------------- | ------------------------------------------- |
| [Apache Maven Clean Plugin][50]                         | [Apache-2.0][15]                            |
| [Apache Maven Install Plugin][51]                       | [Apache-2.0][15]                            |
| [Apache Maven Resources Plugin][52]                     | [Apache-2.0][15]                            |
| [Apache Maven Site Plugin][53]                          | [Apache-2.0][15]                            |
| [SonarQube Scanner for Maven][54]                       | [GNU LGPL 3][55]                            |
| [Apache Maven Toolchains Plugin][56]                    | [Apache-2.0][15]                            |
| [Apache Maven Compiler Plugin][57]                      | [Apache-2.0][15]                            |
| [Apache Maven Enforcer Plugin][58]                      | [Apache-2.0][15]                            |
| [Maven Flatten Plugin][59]                              | [Apache Software License][15]               |
| [org.sonatype.ossindex.maven:ossindex-maven-plugin][60] | [ASL2][61]                                  |
| [Maven Surefire Plugin][62]                             | [Apache-2.0][15]                            |
| [Versions Maven Plugin][63]                             | [Apache License, Version 2.0][15]           |
| [duplicate-finder-maven-plugin Maven Mojo][64]          | [Apache License 2.0][39]                    |
| [Apache Maven Artifact Plugin][65]                      | [Apache-2.0][15]                            |
| [Project Keeper Maven plugin][66]                       | [The MIT License][67]                       |
| [Apache Maven Assembly Plugin][68]                      | [Apache-2.0][15]                            |
| [Apache Maven JAR Plugin][69]                           | [Apache-2.0][15]                            |
| [Artifact reference checker and unifier][70]            | [MIT License][71]                           |
| [Apache Maven Dependency Plugin][72]                    | [Apache-2.0][15]                            |
| [Maven Failsafe Plugin][73]                             | [Apache-2.0][15]                            |
| [JaCoCo :: Maven Plugin][74]                            | [EPL-2.0][46]                               |
...
| [Exec Maven Plugin][81]                                 | [Apache License 2][15]                      |
...
[38]: https://opensource.org/licenses/BSD-2-Clause
...
[47]: https://github.com/eclipse-ee4j/jsonp
[48]: https://projects.eclipse.org/license/epl-2.0
[49]: https://projects.eclipse.org/license/secondary-gpl-2.0-cp
...
[54]: https://docs.sonarsource.com/sonarqube-server/latest/extension-guide/developing-a-plugin/plugin-basics/sonar-scanner-maven/sonar-maven-plugin/
...
[65]: https://maven.apache.org/plugins/maven-artifact-plugin/
...
[82]: https://registry.npmjs.org/@exasol/extension-manager-interface/-/extension-manager-interface-0.4.3.tgz
