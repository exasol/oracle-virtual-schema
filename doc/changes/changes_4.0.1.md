...
**Note:** This only works with property `IMPORT_FROM_ORA=true` when also `GENERATE_JDBC_DATATYPE_MAPPING_FOR_OCI` is set to `true`. Queries will fail with the following error message:
