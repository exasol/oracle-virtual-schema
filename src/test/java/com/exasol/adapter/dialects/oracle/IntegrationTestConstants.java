...
public final class IntegrationTestConstants {
    public static final String VIRTUAL_SCHEMAS_JAR_NAME_AND_VERSION = "virtual-schema-dist-13.0.1-oracle-4.0.1.jar";
    ...
    public static final String EXASOL_VERSION = "2025.1.8";
